...
**Android 通讯基础操作框架，包含Socket、LocalSocket和Ble蓝牙通讯，操作简单。包含蓝牙扫描、多连接、广播包解析、服务读写及通知等功能。支持Socket和LocalSocket连接，自定义解包封包策略，自动重连等**

- **项目地址：** [Glonavin](http://10.168.1.110:8088/#/admin/projects/Glonavin)
